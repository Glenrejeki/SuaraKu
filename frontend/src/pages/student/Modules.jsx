        ...
        <div className="grid lg:grid-cols-12 gap-8">
          <div className="lg:col-span-4 space-y-8">
            {recommendedModules.length > 0 && (
              <section className="bg-indigo-50/50 p-6 rounded-[3rem] border border-indigo-100 border-dashed">
            ...
            <div className="space-y-4">
              <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2 mb-4">Semua Modul</h3>
              <div className="space-y-3">
                {loading ? (
              ...
              {selectedModule ? (
                ...
                >
                  <div className="bg-white p-8 md:p-12 rounded-[3.5rem] border border-slate-100 shadow-sm relative">
                    ...
                    <div className={`prose prose-indigo max-w-none text-slate-600 font-bold leading-relaxed whitespace-pre-wrap h-[500px] overflow-y-auto pr-4 custom-scrollbar ${isTunarungu ? 'text-lg space-y-8' : 'text-sm'}`}>
